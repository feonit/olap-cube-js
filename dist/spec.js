...
var _NormalizedData = __webpack_require__(2);

var _NormalizedData2 = _interopRequireDefault(_NormalizedData);

var _NormalizedDataNotSaved = __webpack_require__(10);
...
var _CreatedMember = __webpack_require__(12);
...
var _Measurements = __webpack_require__(13);
...
var _SchemaMeasurement = __webpack_require__(6);
...
var _NormalizedData2 = __webpack_require__(2);
...
var _Member2 = __webpack_require__(4);
...
describe('common work', function () {
    ...
    it('must be equal etalon and expected cube data', function () {
        ...
        expect(_lodash2.default.isEqual(cube, etalon)).toBe(true);
    });

    it('shold return same array of data', function () {
        var cube = new _cube2.default(arrayData, schema);
        var data = JSON.parse(JSON.stringify(cube.getDataArray()));
        expect(_lodash2.default.isEqual(arrayData, data)).toBe(true);
    });

    it('shold return unique data', function () {
        var cube = new _cube2.default(arrayData, schema);
        var res = cube.unique('prices');
        var expection = [{ id: 1, price: "20$" }, { id: 2, price: "10$" }, { id: 3, price: "20$" }, { id: 4, price: "25$" }];
        expect(_lodash2.default.isEqual(JSON.parse(JSON.stringify(res)), expection)).toBe(true);
    });
});
...
describe('test schema', function () {
    ...
    it('should find dependent measurement', function () {
        var schema = new _Schema2.default([{ name: 'regions', dependency: 'cities', keyProps: ['propName'] }, { name: 'cities', keyProps: ['otherPropName'] }]);
    ...
    it('should return all name of measurements', function () {
        var schema = new _Schema2.default([{ name: 'regions', dependency: 'cities', keyProps: ['propName'] }, { name: 'cities', keyProps: ['otherPropName'] }, { name: 'countries', keyProps: ['else'] }]);
        var res = schema.getNames();
        expect(res.length === 3 && res.indexOf('regions') > -1 && res.indexOf('cities') > -1 && res.indexOf('countries') > -1).toBe(true);
    });
});
