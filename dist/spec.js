...
var _NormalizedDataNotSaved = __webpack_require__(9);
...
var _Member = __webpack_require__(3);

var _Member2 = _interopRequireDefault(_Member);

var _CreatedMember = __webpack_require__(11);
...
var _Measurements = __webpack_require__(12);
...
var _SchemaMeasurement2 = __webpack_require__(5);
...
var _Member2 = __webpack_require__(3);
...
var _SchemaMeasurement = __webpack_require__(5);
...
describe('[ Schema work ]', function () {
    ...
    it('throws when trying to create bad schema', function () {
        expect(function () {
            new _SchemaMeasurement2.default({});
        }).toThrow();
    });

    it('throws when trying to create bad schema from arrayData without id param', function () {
        expect(function () {
            new _NormalizedData2.default({});
        }).toThrow();
    });

    it('should find by name', function () {
        var mesurement = { name: 'boo', keyProps: ['prop'] };
        var schema = new _Schema2.default(mesurement);
        var res = schema.getByName('boo');
        expect(res.name).toBe('boo');
    });

    it('should find dependent measurement', function () {
        ...
        var res = schema.getByDependency('cities');
        expect(res && res.name === 'regions').toBe(true);
    });

    it('should return all name of measurements', function () {
        var schema = new _Schema2.default({
            name: 'regions',
            keyProps: ['regionPropName'],
            dependency: [{
        ...
        var res = schema.getNames();
        expect(res.length === 4 && res.indexOf('regions') > -1 && res.indexOf('cities') > -1 && res.indexOf('countries') > -1 && res.indexOf('data') > -1).toBe(true);
    });
});
...
var etalon = {
    measurements: {
        cities: [{ id: 1, city: 'New York' }, { id: 2, city: 'Paris' }, { id: 3, city: 'Moscow' }],
        companies: [{ id: 1, company: 'AirLine' }, { id: 2, company: 'SkyLine' }],
        age: [{ id: 1, minAgePlane: '1 year', maxAgePlane: '5 year' }, { id: 2, minAgePlane: '5 year', maxAgePlane: '10 year' }],
        prices: [{ id: 1, price: '20$' }, { id: 2, price: '10$' }, { id: 3, price: '20$' }, { id: 4, price: '25$' }],
        counts: [{ id: 1, planesCount: 1 }, { id: 2, planesCount: 1 }, { id: 3, planesCount: 1 }, { id: 4, planesCount: 1 }, { id: 5, planesCount: 2 }]
    },
    normalizedDataArray: [{ id: 1, cities_id: 1, companies_id: 1, age_id: 1, prices_id: 1, counts_id: 1 }, { id: 2, cities_id: 2, companies_id: 2, age_id: 2, prices_id: 2, counts_id: 3 }, { id: 3, cities_id: 2, companies_id: 1, age_id: 2, prices_id: 2, counts_id: 2 }, { id: 4, cities_id: 3, companies_id: 1, age_id: 1, prices_id: 3, counts_id: 4 }, { id: 5, cities_id: 3, companies_id: 2, age_id: 1, prices_id: 4, counts_id: 5 }]
};

var arrayData = [{ id: 1, city: 'New York', company: 'AirLine', minAgePlane: '1 year', maxAgePlane: '5 year', planesCount: 1, price: '20$' }, { id: 2, city: 'Paris', company: 'SkyLine', minAgePlane: '5 year', maxAgePlane: '10 year', planesCount: 1, price: '10$' }, { id: 3, city: 'Paris', company: 'AirLine', minAgePlane: '5 year', maxAgePlane: '10 year', planesCount: 1, price: '10$' }, { id: 4, city: 'Moscow', company: 'AirLine', minAgePlane: '1 year', maxAgePlane: '5 year', planesCount: 1, price: '20$' }, { id: 5, city: 'Moscow', company: 'SkyLine', minAgePlane: '1 year', maxAgePlane: '5 year', planesCount: 2, price: '25$' }];

var schema = [{ name: 'cities', keyProps: ['city'] }, { name: 'companies', keyProps: ['company'] }, { name: 'age', keyProps: ['minAgePlane', 'maxAgePlane'] }, { name: 'prices', keyProps: ['price'], dependency: 'cities' }, { name: 'counts', keyProps: ['planesCount'], dependency: ['cities', 'companies'] }];
...
describe('[ Cube work ]', function () {
    ...
    it('should add column to cube data', function () {
        var arrayData = [{ id: 1, x: 0, y: 0, value: 10 }, { id: 2, x: 0, y: 1, value: 100 }, { id: 3, x: 1, y: 0, value: 1000 }, { id: 4, x: 1, y: 1, value: 10000 }];
        ...
        var ealon = {
            ...
            "measurements": {
                "coordinateY": [{ "id": 1, "y": 0 }, { "id": 2, "y": 1 }],
                "coordinateX": [{ "id": 1, "x": 0 }, { "id": 2, "x": 1 }],
                "valueOfXY": [{ "id": 1, "value": 10 }, { "id": 2, "value": 100 }, { "id": 3, "value": 1000 }, { "id": 4, "value": 10000 }]
            }
        };
        ...
        var ealonAfterAdding = {
            "normalizedDataArray": [{ "id": 1, "coordinateY_id": 1, "coordinateX_id": 1, "valueOfXY_id": 1 }, { "id": 2, "coordinateY_id": 2, "coordinateX_id": 1, "valueOfXY_id": 2 }, { "id": 3, "coordinateY_id": 1, "coordinateX_id": 2, "valueOfXY_id": 3 }, { "id": 4, "coordinateY_id": 2, "coordinateX_id": 2, "valueOfXY_id": 4 }, { "id": null, "coordinateY_id": 1, "coordinateX_id": 3, "valueOfXY_id": 5 }, { "id": null, "coordinateY_id": 2, "coordinateX_id": 3, "valueOfXY_id": 6 }],
            "measurements": {
                "coordinateY": [{ "id": 1, "y": 0 }, { "id": 2, "y": 1 }],
                "coordinateX": [{ "id": 1, "x": 0 }, { "id": 2, "x": 1 }, { "id": 3, "x": 2 }],
                "valueOfXY": [{ "id": 1, "value": 10 }, { "id": 2, "value": 100 }, { "id": 3, "value": 1000 }, { "id": 4, "value": 10000 }, { "id": 5, "value": null }, { "id": 6, "value": null }]
            }
        };
    ...
    it('should add column to cube data with dependency columns', function () {
